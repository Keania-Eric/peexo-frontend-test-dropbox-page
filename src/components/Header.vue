<template>
    <header class="font-light text-xl w-11/12 text-white fixed mx-14 flex p-2 font-create-round">
        ...
        <div id="nav-seperator" class="w-2/5"></div>

        <nav id="top-right-nav" class="w-1/5">
            <ul clas>

                <li class="inline-block m-2"><a href="#" class="p-4">Sign In</a></li>
                <li class="inline-block m-2"><a href="#" class="p-4">Sign Up</a></li>
            </ul>
        </nav>
